...
class SyntaxConverter:
    ...
    def parse_elf(file, elf, starting_function, start_addr, size, section_name, ret, caller, call_dic):
        ...
        while(i < len(opcode)):
            ...
            instr.set_info(instr_string, length, address, arguments, clock, op_list[0][i:], register, index, immediate, indirect, dst_register, dst_index, file, as_mode, ad_mode, abs_instr.ti_profiles)
