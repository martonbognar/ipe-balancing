        ...
        while len(pending_ep) > 0:
            ...
            try:
                ...
                if timing_sensitive:
                    ...
                    pass
            except MPUOnHighConditionException as mpu:
                if timing_sensitive:
                    assignments[current_ep] = current_ac
                    return Analysis.result(AnalysisResult.MPU_VULNERABILITY, current_ep, None, assignments, unique_ret, mpu.instr_then, mpu.instr_else)
                else:
                    pass
            except CacheOnHighConditionException as cache:
                if timing_sensitive:
                    assignments[current_ep] = current_ac
                    return Analysis.result(AnalysisResult.CACHE_VULNERABILITY, current_ep, None, assignments, unique_ret, cache.instr_then, cache.instr_else)
                else:
                    pass
